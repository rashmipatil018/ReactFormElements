...
class FormContainer extends Component {
	...
	//Code to add a button that allows the builder to clear the form and start fresh
	handleClearForm(e) {
		e.preventDefault();
		this.setState({
			Name: '',
	...
	//Code to allow user to select "multi-select"
	...
	handleFormSubmit(e) {
		...
		//Code that creates a JSON object and posts to the console
	...
	render() {
		...
		//Code to limit the number of new choices to add to 5
		const isValidNewOption = (inputValue, selectValue) =>
		inputValue.length > 0 && selectValue.length < 5;
		
		//Code to limit the number of total choices to add to 10
		const Menu = props => {
